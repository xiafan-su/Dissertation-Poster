...
of parse tree, lazy evaluation can enable the possibilty of ``parse by need'', which will
save lots of memory and time and become much more efficient.
...
\item More specific rules. The parser will try the rules one by one. Try the most possible
rules based on parsing context will help to find the correct result earlier.
\end{itemize}
