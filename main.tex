...
\item Expressiveness: Not as expressive as Hugh's library, but it is complete and enough for using.
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/cs1.png}

\end{figure}
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/cs2.png}

\end{figure}
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/cs3.png}
